...
(function($) {
    ...
    // Stops animations/transitions until the page has fully loaded.
    ...
    if (toggleButton) { // Ensure the element exists
        toggleButton.onclick = function() {
            ...
            if (hiddenText.style.display === "none") {
                ...
                button.textContent = "A Little Bit About Myself"; // Change button text
            } else {
                hiddenText.style.display = "none";
                button.textContent = "A Little Bit About Myself"; // Change button text back
            }
        };
    }
