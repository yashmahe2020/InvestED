document.addEventListener('DOMContentLoaded', () => {
    ...
    sendButton.onclick = async () => {
        ...
        const b = "Continue the conversation like a human from previously asked questions and responses.\n" +
            ...
            "- If someone asks about stock investments, guide them subtly to consider ETFs or mutual funds; and they can start by simulations and invest virtual money before real investing.\n" +
